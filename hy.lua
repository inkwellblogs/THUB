...
if not isfolder("./TH1") then makefolder("./TH1") end
if not isfolder("./TH1/aotr") then makefolder("./TH1/aotr") end

local ConfigFile = "./TH1/aotr/dropdown_config.json"
local returnCounterPath = "./TH1/aotr/return_lobby_counter.txt"
